# ==========================================
# 贝才 3.1.1 APK 一键编译 PowerShell 脚本
# ==========================================
...
Write-Host "     BeiCai v3.1.1 APK Build Script" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path $ApkPath) {
    Copy-Item -Path $ApkPath -Destination "$ScriptDir\beicai-apk-v3.1.1.apk" -Force
    Write-Host ""
    Write-Host "==========================================" -ForegroundColor Green
    Write-Host "[SUCCESS] Built successfully: beicai-apk-v3.1.1.apk" -ForegroundColor Green
    Write-Host "==========================================" -ForegroundColor Green
} else {
